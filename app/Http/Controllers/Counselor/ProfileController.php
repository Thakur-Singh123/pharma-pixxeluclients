...
class ProfileController extends Controller
{
    ...
    public function profile() {
        ...
        return view('counselor.profiles.profile', compact('user_profile'));
    }
    ...
    public function edit_profile() {
        ...
        //Get user detail
        $user_profile = User::where('id', $is_login_id)->first();
        return view('counselor.profiles.edit-profile', compact('user_profile'));
    } 
    ...
    public function change_password() {
        ...
        //Get user detail
        $user_profile = User::where('id', $is_login_id)->first();
        return view('counselor.profiles.change-password', compact('user_profile'));
    }
