...
class ProfileController extends Controller
{
    ...
    public function profile() {
        ...
        return view('manager.profiles.profile', compact('user_profile'));
    }
    ...
    $is_login_id = Auth::user()->id;
    $user_profile = User::where('id', $is_login_id)->first();
        return view('manager.profiles.edit-profile', compact('user_profile'));
    } 
    ...
    public function change_password() {
        ...
        $is_login_id = Auth::user()->id;
        $user_profile = User::where('id', $is_login_id)->first();
        return view('manager.profiles.change-password', compact('user_profile'));
    }
