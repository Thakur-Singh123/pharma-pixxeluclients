...
<body>
    <div class="wrapper">
        @include('counselor.sidebar.sidebar')
                                ...
                                <ul class="dropdown-menu dropdown-user animated fadeIn">
                                    <div class="dropdown-user-scroll scrollbar-outer">
                                        ...
                                        <li>
                                            ...
                                            <a class="dropdown-item {{ Request::is('counselor/edit-profile') ? 'active' : '' }}"
                                                href="{{ url('counselor/edit-profile') }}">
                                                Edit Profile
                                            </a>
                                            <a class="dropdown-item {{ Request::is('counselor/change-password') ? 'active' : '' }}"
                                                href="{{ url('counselor/change-password') }}">
                                                Update Password
                                            </a>
