                        ...
                        <div class="card-body">
                            <form action="{{ route('counselor.bookings.store') }}" method="POST" autocomplete="off">
                                ...
                                <div class="row">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" id="department" name="department">
                                                ...
                                                <option value="Pediatrics"
                                                    {{ old('department') == 'Pediatrics' ? 'selected' : '' }}>Pediatrics
                                                </option>
                                                <option value="OBS & GGYNAE"
                                                    {{ old('department') == 'OBS & GGYNAE' ? 'selected' : '' }}>OBS & GGYNAE
                                                </option>
                                                <option value="Urology"
                                                    {{ old('department') == 'Urology' ? 'selected' : '' }}>Urology</option>
                                                <option value="General Surgery"
                                                    {{ old('department') == 'General Surgery' ? 'selected' : '' }}>General
                                                    Surgery</option>
                                                <option value="Pediatric Surgery"
                                                    {{ old('department') == 'Pediatric Surgery' ? 'selected' : '' }}>
                                                    Pediatric Surgery</option>
                                                <option value="Internal Medicine"
                                                    {{ old('department') == 'Internal Medicine' ? 'selected' : '' }}>
                                                    Internal Medicine</option>
                                                <option value="IVF" {{ old('department') == 'IVF' ? 'selected' : '' }}>
                                                    IVF</option>
                                                <option value="Others"
                                                    {{ old('department') == 'Others' ? 'selected' : '' }}>Others</option>
                                            </select>
                                            @error('department')
                                                <small class="text-danger">{{ $message }}</small>
                                            @enderror
                                    ...
                                    <div class="col-md-6 col-lg-4">
                                        <div class="form-group"> <label for="booking_done">Booking Done</label> <select
                                                class="form-control" id="booking_done" name="booking_done">
                                                <option value="" disabled selected>Select Option</option>
                                                <option value="Yes"
                                                    {{ old('booking_done') == 'Yes' ? 'selected' : '' }}>Yes</option>
                                                <option value="No" {{ old('booking_done') == 'No' ? 'selected' : '' }}>
                                                    No</option>
                                            </select> @error('booking_done')
                                                <small class="text-danger">{{ $message }}</small>
                                            @enderror
                                        </div>
                                    </div>
