                        ...
                        <div class="card-body">
                            <form action="{{ route('counselor.bookings.update', $patient->id) }}" method="POST"
                                ...
                                <div class="row">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" id="department" name="department">
                                                ...
                                                <option value="Pediatrics"
                                                    {{ old('department', $mainDept) == 'Pediatrics' ? 'selected' : '' }}>
                                                    Pediatrics</option>
                                                <option value="OBS & GGYNAE"
                                                    {{ old('department', $mainDept) == 'OBS & GGYNAE' ? 'selected' : '' }}>
                                                    OBS & GGYNAE</option>
                                                <option value="Urology"
                                                    {{ old('department', $mainDept) == 'Urology' ? 'selected' : '' }}>
                                                    Urology</option>
                                                <option value="General Surgery"
                                                    {{ old('department', $mainDept) == 'General Surgery' ? 'selected' : '' }}>
                                                    General Surgery</option>
                                                <option value="Pediatric Surgery"
                                                    {{ old('department', $mainDept) == 'Pediatric Surgery' ? 'selected' : '' }}>
                                                    Pediatric Surgery</option>
                                                <option value="Internal Medicine"
                                                    {{ old('department', $mainDept) == 'Internal Medicine' ? 'selected' : '' }}>
                                                    Internal Medicine</option>
                                                <option value="IVF"
                                                    {{ old('department', $mainDept) == 'IVF' ? 'selected' : '' }}>IVF
                                                </option>
                                                <option value="Others"
                                                    {{ old('department', $mainDept) == 'Others' ? 'selected' : '' }}>Others
                                                </option>
                                            </select>
                                            @error('department')
                                                <small class="text-danger">{{ $message }}</small>
                                    ...
                                    <div class="col-md-12" id="otherDepartmentBox"
                                    ...
                                    <div class="col-md-12" id="otherDepartmentBox" style="display: none;">
                                        <div class="form-group">
                                            <label for="other_department">Specify Other Department</label>
                                            <textarea class="form-control" id="other_department" name="other_department" rows="3"
                                                placeholder="Enter other department name here...">{{ old('other_department', $patient->other_department) }}</textarea>
                                        </div>
                                    </div>
                                    ...
                                    {{-- <div class="col-md-6 col-lg-4">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" id="booking_done" name="booking_done">
                                                ...
                                                <option value="Yes"
                                                    {{ old('booking_done', $patient->booking_done) == 'Yes' ? 'selected' : '' }}>
                                                    Yes</option>
                                                <option value="No"
                                                    {{ old('booking_done', $patient->booking_done) == 'No' ? 'selected' : '' }}>
                                                    No</option>
                                            </select>
                                            @error('booking_done')
                                                <small class="text-danger">{{ $message }}</small>
                                    ...
                                    <div class="col-md-6 col-lg-4">
                                        <div class="form-group">
                                            ...
                                            <textarea name="remark" class="form-control" rows="2" placeholder="Any additional remark">{{ old('remark', $patient->remark) }}</textarea>
                                            @error('remark')
                                                <small class="text-danger">{{ $message }}</small>
                                            @enderror
                                        </div>
