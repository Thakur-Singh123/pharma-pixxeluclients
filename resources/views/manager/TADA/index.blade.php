                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header d-flex justify-content-between align-items-center">
                                ...
                                <form method="GET" action="{{ route('manager.tada.index') }}" class="m-0 d-flex align-items-center" style="gap: 10px;">
                                    <select name="status" class="form-control" onchange="if(this.value==''){ window.location='{{ route('manager.tada.index') }}'; } else { this.form.submit(); }">
                                                            ...
                                                            <tr role="row">
                                                                ...
                                                                <td style="display: flex; gap: 5px;">
                                                                    @if ($tada_record->status == 'pending')
                                                                        <form method="POST"
                                                                            action="{{ route('manager.ta_da.approve', $tada_record->id) }}">
                                                                            @csrf
                                                                            <button
                                                                        ...
                                                                        <form method="POST"
                                                                            action="{{ route('manager.ta_da.reject', $tada_record->id) }}">
                                                                            @csrf
                                                                            <button
