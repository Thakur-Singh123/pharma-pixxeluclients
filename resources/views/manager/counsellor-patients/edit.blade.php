        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('manager.update.booking', $patient->id) }}" method="POST" autocomplete="off">
                            @csrf
                            <div class="row">
                                <!--Patient Name-->
                                <div class="col-md-6 col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="patient_name" name="patient_name" value="{{ old('patient_name', $patient->patient_name) }}"
                                ...
                                <div class="col-md-6 col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" id="mobile_no" name="mobile_no" value="{{ old('mobile_no', $patient->mobile_no) }}"
                                ...
                                <div class="col-md-12" id="otherDepartmentBox" style="display: {{ old('department', $mainDept) == 'Others' ? 'block' : 'none' }};">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" id="other_department" name="other_department" rows="3"
                                            placeholder="Enter other department name here...">
                                            {{ old('other_department', $otherDeptValue) }}
                                        </textarea>
                                    </div>
                                </div>
                                <!--UHID Number-->
                                <div class="col-md-6 col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="uhid_no" name="uhid_no" value="{{ old('uhid_no', $patient->uhid_no) }}"
