                        ...
                        <div class="col-md-8">
                           <div class="form-group">
                              ...
                              <textarea name="comments" class="form-control" rows="4"
                                 placeholder="Enter comments">{{ old('comments', $visit_detail->comments) }}
                              </textarea>
                              @error('comments')
                                 <small class="text-danger">{{ $message }}</small>
                              @enderror
                        ...
                        <div class="col-md-8 visit-extra visit-villages" style="display:none;">
                           <div class="form-group">
                              ...
                              <textarea name="villages" class="form-control" rows="3"
                                 placeholder="Enter village, pin code, contacts of sarpanch, panch, important person of village, designation">{{ old('villages',$visit_detail->villages) }}
                              </textarea>
                              @error('villages')
                                 <small class="text-danger">{{ $message }}</small>
                              @enderror
                        ...
                        <div class="col-md-8 visit-extra visit-city" style="display:none;">
                           <div class="form-group">
                              ...
                              <textarea name="city" class="form-control" rows="3"
                                 placeholder="Enter city, sector/ward, important person">{{ old('city',$visit_detail->city) }}
                              </textarea>
                              @error('city')
                                 <small class="text-danger">{{ $message }}</small>
                              @enderror
                        ...
                        <div class="col-md-8 visit-extra visit-societies" style="display:none;">
                           <div class="form-group">
                              ...
                              <textarea name="societies" class="form-control" rows="3"
                                 placeholder="Enter societies, contacts of past or present members, important persons">{{ old('societies',$visit_detail->societies) }}
                              </textarea>
                              @error('societies')
                                 <small class="text-danger">{{ $message }}</small>
                              @enderror
                        ...
                        <div class="col-md-8 visit-extra visit-religious_places" style="display:none;">
                           <div class="form-group">
                              ...
                              <textarea name="religious_place_name" class="form-control" rows="3"
                                 placeholder="Enter religious places, contacts">{{ old('religious_place_name',$visit_detail->religious_place) }}
                              </textarea>
                        ...
                        <div class="col-md-8 visit-extra visit-other" style="display:none;">
                           <div class="form-group">
                              ...
                              <textarea name="other_visit_details" class="form-control" rows="3"
                                 placeholder="Enter other visit details">{{ old('other_visit_details',$visit_detail->other_visit) }}
                              </textarea>
