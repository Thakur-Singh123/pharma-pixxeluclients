            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="{{ route('manager.update.doctor', $doctor_detail->id) }}" method="POST"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 col-lg-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="doctor_contact"
                                                name="doctor_contact"
                                    ...
                                    <div class="col-md-6 col-lg-4">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" id="visit_type" name="mr_id[]" multiple>
                                                @foreach ($mrs as $mr)
                                                    <option value="{{ $mr->id }}"
                                                        {{ in_array($mr->id, $assignedMrsIds) ? 'selected' : '' }}>
                                                        {{ $mr->name }}
                                                    </option>
                                                @endforeach
                                            </select>
