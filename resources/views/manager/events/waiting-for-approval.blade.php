                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                                ...
                                <form method="GET" action="{{ route('manager.waiting.for.approval') }}" class="m-0 d-flex align-items-center" style="gap: 10px;">
                                    <input type="date"
                                        name="start_date"
                                        class="form-control"
                                                    ...
                                                    <tbody>
                                                        ...
                                                        @forelse ($events as $event)
                                                            <tr role="row">
                                                                ...
                                                                <td>
                                                                    <!--Check if qr image exists or not-->
                                                                    {!! $event->qr_code_path 
