                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <input type="date" class="form-control" id="joining_date" name="joining_date" value="{{ old('joining_date', $mr_detail->joining_date ?? now()->format('Y-m-d')) }}" min="{{ now()->format('Y-m-d') }}">
                                        @error('joining_date')
                                            <small class="text-danger">{{ $message }}</small>
                                        @enderror
                                    </div>
