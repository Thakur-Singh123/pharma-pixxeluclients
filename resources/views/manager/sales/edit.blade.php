                            ...
                            <form method="POST" action="{{ route('manager.sales.update', $sale->id) }}" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <input type="text" name="name" class="form-control" value="{{ old('name', $sale->name) }}" required>
                                    </div>
                                    <div class="col-md-4">
                                        <label>Email</label>
                                        <input type="email" name="email" class="form-control" value="{{ old('email', $sale->email) }}" required>
                                    </div>
                                    <div class="col-md-4">
                                        <label>Designation</label>
                                        <input type="text" name="designation" class="form-control" value="{{ old('designation', $sale->designation) }}" required>
                                    </div>
                                    <div class="col-md-4">
                                        <label>Phone</label>
                                        <input type="number" name="phone" class="form-control" value="{{ old('phone', $sale->phone) }}" required>
                                    </div>
                                    <div class="col-md-4">
                                        <label>Company Address</label>
                                        <input type="text" name="address" class="form-control" value="{{ old('address', $sale->address) }}" required>
                                    </div>
                                </div>
                                <!--Doctor & Prescription-->
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <input type="text" name="doctor_name" class="form-control" value="{{ old('doctor_name', $sale->doctor_name) }}" required>
                                    </div>
                                    <div class="col-md-4">
                                ...
                                <h4>Products</h4>
                                    <table class="table table-bordered" id="medicineTable">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td>
                                                    <input name="salt_name[]" class="form-control" value="{{ old("salt_name.$i", $items[$i]->salt_name ?? '') }}">
                                                </td>
                                                <td>
                                                    <input name="brand_name[]" class="form-control" value="{{ old("brand_name.$i", $items[$i]->brand_name ?? '') }}">
                                                </td>
                                                <td>
                                                    <input name="company[]" class="form-control" value="{{ old("company.$i", $items[$i]->company ?? '') }}">
                                                </td>
                                                <td>
                                                    <input name="base_price[]" class="form-control base" value="{{ old("base_price.$i", $items[$i]->base_price ?? '') }}" oninput="calcTotal()">
                                                </td>
                                                <td>
                                                    <input type="number" name="sale_price[]" class="form-control rate" value="{{ old("sale_price.$i", $items[$i]->sale_price ?? '') }}" oninput="calcTotal()">
                                                </td>
                                                <td>
