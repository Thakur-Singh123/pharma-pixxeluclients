                            ...
                            <div class="card">
                                <div class="card-header d-flex justify-content-between align-items-center">
                                    <h4 class="card-title">Interested MRS</h4>
                                     <form method="GET" action="{{ route('manager.visit.plans.interested.mrs') }}" class="m-0 d-flex align-items-center" style="gap: 10px;">
                                        <input type="date"
                                            name="start_date"
                                            class="form-control"
                                        ...
                                        <div id="basic-datatables_wrapper"
                                            ...
                                            <div class="row">
                                                <div class="col-sm-12">
                                                    ...
                                                    {{ $intrested_mrs->appends(request()->query())->links('pagination::bootstrap-5') }}
                                                </div>
                                            </div>
                                        </div>
                                    </div>
