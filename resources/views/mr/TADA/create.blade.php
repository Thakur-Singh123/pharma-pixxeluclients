                ...
                <div class="col-md-12">
                    ...
                    <div class="card">
                        <div class="card-header d-flex justify-content-between align-items-center">
                            <h4 class="card-title">TA/DA Claim Form</h4>
                        </div>
                        <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 col-lg-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="place_visited" class="form-control"
                                                placeholder="Enter Place Visited" value="{{ old('place_visited') }}">
                                                 @error('place_visited')
                                           <small class="text-danger">{{ $message }}</small>
                                        @enderror
                                        </div>
                                    ...
                                    <div class="col-md-6 col-lg-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="distance_km" class="form-control"
                                                placeholder="Enter Distnace" value="{{ old('distance_km') }}">
                                                 @error('distance_km')
                                           <small class="text-danger">{{ $message }}</small>
                                        @enderror
                                        </div>
                                    ...
                                    <div class="col-md-6 col-lg-4">
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="ta_amount" class="form-control"
                                                placeholder="Enter travel allowance" value="{{ old('ta_amount') }}">
                                                 @error('ta_amount')
                                           <small class="text-danger">{{ $message }}</small>
                                        @enderror
                                        </div>
                                    ...
                                    <div class="col-md-6 col-lg-4">
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="da_amount" class="form-control"
                                                placeholder="Enter daily allowance" value="{{ old('da_amount') }}">
                                                 @error('da_amount')
                                           <small class="text-danger">{{ $message }}</small>
                                        @enderror
                                        </div>
