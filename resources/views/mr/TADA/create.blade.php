                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="distance_km" class="form-control" placeholder="Enter distance" value="{{ old('distance_km') }}">
                                        @error('distance_km')
                                            <small class="text-danger">{{ $message }}</small>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-6 col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <textarea name="outstation_stay" class="form-control" rows="2" placeholder="Enter outstation stay">{{ old('outstation_stay') }}</textarea>
