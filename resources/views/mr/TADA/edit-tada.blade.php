                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <input type="date" name="travel_date" class="form-control" value="{{ old('travel_date',$tada_detail->travel_date) }}">
                                        @error('travel_date')
                                ...
                                <div class="col-md-6 col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="distance_km" class="form-control" placeholder="Enter distnace" value="{{ old('distance_km',$tada_detail->distance_km) }}">
                                        @error('distance_km')
                                            <small class="text-danger">{{ $message }}</small>
                                        @enderror
                                    </div>
