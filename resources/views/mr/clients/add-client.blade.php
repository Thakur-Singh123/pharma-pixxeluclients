                                ...
                                <div class="col-md-6 col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <select name="category_type" id="category_type" class="form-control">
                                            ...
                                            <option value="doctor" @if(old('category_type') == 'doctor') selected @endif>Doctor</option>
                                            <option value="nurse" @if(old('category_type') == 'nurse') selected @endif>Nurse</option>
                                            <option value="lab_technician" @if(old('category_type') == 'lab_technician') selected @endif>Lab Technician</option>
                                            <option value="chemist" @if(old('category_type') == 'chemist') selected @endif>Chemist</option>
                                            <option value="asha_worker" @if(old('category_type') == 'asha_worker') selected @endif>Asha Worker</option>
                                            <option value="sarpanch" @if(old('category_type') == 'sarpanch') selected @endif>Sarpanch</option>
                                            <option value="mc" @if(old('category_type') == 'mc') selected @endif>MC</option>
                                            <option value="franchisee" @if(old('category_type') == 'franchisee') selected @endif>Franchisee</option>
                                            <option value="healthcare_worker" @if(old('category_type') == 'healthcare_worker') selected @endif>Any Healthcare Worker</option>
                                            <option value="others" @if(old('category_type') == 'others') selected @endif>Others</option>
                                        </select>
                                        @error('category_type')
                                ...
                                <div class="col-md-4 extra doctor" style="display:none;">
                                    <div class="form-group">
                                        ...
                                        <select name="hospital_type" class="form-control" required>
                                            ...
                                            <option value="clinic" {{ old('hospital_type') == 'clinic' ? 'selected' : '' }}>Clinic</option>
                                            <option value="other" {{ old('hospital_type') == 'other' ? 'selected' : '' }}>Other</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-md-4 extra doctor" style="display:none;">
