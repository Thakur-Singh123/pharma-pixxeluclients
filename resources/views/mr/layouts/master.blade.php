                                 ...
                                 <li>
                                    <div class="user-box">
                                       ...
                                       <div class="u-text">
                                          ...
                                          <a href="{{ url('mr/profile') }}" class="profile-btn btn-xs btn-secondarys btn-sm">View Profile</a>
                                       </div>
                                    </div>
                                 </li>
                                 <li>
                                    <div class="dropdown-divider"></div>
                                    <a class="dropdown-item {{ Request::is('mr/edit-profile') ? 'active' : '' }}" href="{{ url('mr/edit-profile') }}">
                                       Edit Profile
                                    </a>
                                    <a class="dropdown-item {{ Request::is('mr/change-password') ? 'active' : '' }}" href="{{ url('mr/change-password') }}">
                                       Update Password
                                    </a>
