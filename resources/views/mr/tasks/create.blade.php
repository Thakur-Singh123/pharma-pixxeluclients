            ...
            <div class="col-md-12">
                ...
                <div class="card">
                    <div class="card-header">
                        <div class="card-title">Tasks Calendar
<form id="sendMonthlyForm" action="{{ route('mr.tasks.sendMonthly') }}" method="POST">
    @csrf
    <button type="submit" class="btn btn-link float-end" style="text-decoration: none;">
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="date" class="form-control start-date" id="start_date" name="start_date">
                        </div>

                        <!-- End Date -->
                        <div class="col-md-6 mb-3">
                            <label for="end_date">End Date</label>
                            <input type="date" class="form-control end-date" id="end_date" name="end_date">
                        </div>
