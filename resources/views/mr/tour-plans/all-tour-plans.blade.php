                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header d-flex justify-content-between align-items-center">
                                    <h4 class="card-title">Assign Tour plans</h4>
                                    <!-- <form method="GET" action="{{ route('mr.tour-plans.index') }}">
                                                ...
                                                <div class="col-sm-12">
                                                    <table id="basic-datatables"
                                                        ...
                                                        <tbody>
                                                            @php $count = 1 @endphp
                                                            <!--Get tasks-->
                                                            @forelse ($all_task_tour_plan as $task)
                                                                <tr role="row">
                                                                    ...
                                                                    <td>
                                                                        <div class="form-button-action">
                                                                            <a href="{{ route('mr.tour-plans.edit', $task->id) }}" class="icon-button edit-btn custom-tooltip" data-tooltip="Edit">
