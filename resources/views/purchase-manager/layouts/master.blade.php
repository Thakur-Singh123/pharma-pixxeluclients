                                ...
                                <ul class="dropdown-menu dropdown-user animated fadeIn">
                                    <div class="dropdown-user-scroll scrollbar-outer">
                                        ...
                                        <li>
                                            ...
                                            <a class="dropdown-item {{ Request::is('purchase-manager/edit-profile') ? 'active' : '' }}"
                                                href="{{ url('purchase-manager/edit-profile') }}">
                                                Edit Profile
                                            </a>
                                            <a class="dropdown-item {{ Request::is('purchase-manager/change-password') ? 'active' : '' }}"
                                                href="{{ url('purchase-manager/change-password') }}">
                                                Update Password
                                            </a>
