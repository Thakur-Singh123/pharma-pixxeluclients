                                ...
                                <ul class="dropdown-menu dropdown-user animated fadeIn">
                                    <div class="dropdown-user-scroll scrollbar-outer">
                                        ...
                                        <li>
                                            ...
                                            <a class="dropdown-item {{ Request::is('vendor/edit-profile') ? 'active' : '' }}"
                                                href="{{ url('vendor/edit-profile') }}">
                                                Edit Profile
                                            </a>
                                            <a class="dropdown-item {{ Request::is('vendor/change-password') ? 'active' : '' }}"
                                                href="{{ url('vendor/change-password') }}">
                                                Update Password
                                            </a>
