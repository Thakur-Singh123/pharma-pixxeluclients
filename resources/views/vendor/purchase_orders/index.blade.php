                    ...
                    <div class="card-header d-flex justify-content-between align-items-center">
                        ...
                        <form method="GET" action="{{ route('vendor.purchase-orders.index') }}"
                            ...
                            <select name="is_delivered" class="form-control" style="width: 160px"
                                onchange="if(this.value==''){ window.location='{{ route('vendor.purchase-orders.index') }}'; } else { this.form.submit(); }">
                            ...
                            >
                            {{-- Date Range Filter --}}
                            <select name="date_range" class="form-control" style="width: 160px"
                                onchange="if(this.value==''){ window.location='{{ route('vendor.purchase-orders.index') }}'; } else { this.form.submit(); }">
